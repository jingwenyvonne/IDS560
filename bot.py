...
class Bot:
    ...
    def connect(self) -> bool:
            # Use self.browser to open a Chrome tab and navigate to Instagram login page
            ...
            self.browser.find_element_by_xpath(login_Xpath).click()
            sleep(5)

            # Click "Not Now" on "Save Your Login Info?" popup
            not_now = self.browser.find_element_by_css_selector("#react-root > section > main > div > div > div > div > button")
            not_now.click()
            sleep(randint(2,5))

            # Click "Not Now" on popup "Turn on Notifications"
            not_now = self.browser.find_element_by_css_selector("body > div.RnEpo.Yx5HN > div > div > div > div.mt3GC > button.aOOlW.HoLwm")
            not_now.click()
            sleep(randint(2,5))
            return True
      ...
      #refresh
    def refresh():
            self.browser.get("https://www.instagram.com/jewelrymdjewelry/")
            sleep(randint(2,5))
            picture=self.browser.find_element_by_css_selector("#react-root > section > main > div > div._2z6nI > article > div > div > div > div.v1Nh3.kIKUG._bz0w > a > div > div._9AhH0")
            picture.click()
            sleep(randint(2,5))
            comment = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.eo2As > section.sH9wk._JgwE > div > form > textarea")
            comment.click()
            sleep(randint(2,5))
            ...
            sleep(randint(2,5))
            comment_click = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.eo2As > section.sH9wk._JgwE > div > form > button > div")
            comment_click.click()
    ...
    def num_followers(username):
            ...
            sleep(3)
            num_of_followers = self.browser.find_element_by_css_selector('#react-root > section > main > div > header > section > ul > li:nth-child(2) > a > div > span').text
    ...
    def unfollow():
          if (time.time()-my_dict_time ['unfollow_timer']) < 3600 and my_dict['unfollowed']<limits['unfollow_limit_per_hour']:
              ...
              for i in range(5):
                  self.browser.get("https://www.instagram.com/jewelrymdjewelry/")
                  following_=self.browser.find_element_by_partial_link_text("following")
                  following_.click()
                  sleep(randint(1,3))
                  self.browser.find_element_by_xpath("/html/body/div[6]/div/div/div/div[3]/ul/div/li[1]/div/div[3]/button").click()
                  sleep(randint(1,3))
                  self.browser.find_element_by_xpath("/html/body/div[7]/div/div/div/div[3]/button[1]").click()
                  sleep(randint(1,3))
    ...
    def follow():
          follow_ = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.UE9AK > div > header > div.o-MQd.z8cbW > div.PQo_0.RqtMr > div.bY2yH > button > div")
          username = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.UE9AK > div > header > div.o-MQd.z8cbW > div.PQo_0.RqtMr > div.e1e1d > div > span > a").text
    ...
    def like ():
          if (time.time()-my_dict_time ['like_timer']) < 3600 and my_dict['likes'] <limits['like_limit_per_hour']:
              like = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.pbNvD.QZZGH.bW6vo > div > article > div > div.HP0qD > div > div > div.eo2As > section.ltpMr.Slqrh > span.fr66n > button")
              like.click()
              sleep(randint(30,60))
    ...
    def hashtag():
          for hashtag in hashtag_list:
              ...
              first_thumbnail = self.browser.find_element_by_css_selector("#react-root > section > main > article > div.EZdmt > div > div > div:nth-child(1) > div:nth-child(2) > a > div > div._9AhH0")
          ...
          #                Click "next" to go to next picture within the same hashtag
                          next = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.Z2Inc._7c9RR > div > div.l8mY4.feth3 > button")
                          next.click()
                          sleep(randint(2,5))
                          ...
                          if driver_len > 1: # Will execute if more than 1 tabs found.
                              for i in range(driver_len - 1, 0, -1):
                                  self.browser.switch_to.window(self.browser.window_handles[i]) #will close the last tab first.
                                  self.browser.close()
                              self.browser.switch_to.window(self.browser.window_handles[0]) # Switching the driver focus to First tab.
          #               Click "next" to go to next picture within the same hashtag
                          next = self.browser.find_element_by_css_selector("body > div.RnEpo._Yhr4 > div.Z2Inc._7c9RR > div > div.l8mY4.feth3 > button")
                          next.click()
                          sleep(randint(2,5))
